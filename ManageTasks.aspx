...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MemberSection.Master" CodeBehind="ManageTasks.aspx.cs" Inherits="PitStop.ManageTasks" EnableEventValidation="false" %>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvStudentId" runat="server" ControlToValidate="txtStudentId" ErrorMessage="Student ID is required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>Title:</td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="txtTitle" ErrorMessage="Title is required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>Description:</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvXP" runat="server" ControlToValidate="txtXPReward" ErrorMessage="XP Reward is required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="rvXP" runat="server" ControlToValidate="txtXPReward" MinimumValue="1" MaximumValue="1000" Type="Integer" ErrorMessage="XP must be between 1-1000" ForeColor="Red" Display="Dynamic"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
                <td>Due Date:</td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvDueDate" runat="server" ControlToValidate="txtDueDate" ErrorMessage="Due date is required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
